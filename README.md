...
| [grill-with-docs](grill-with-docs/SKILL.md) | model | Entry point: `grill-me` + `domain-modeling` (grill with a paper trail) | mattpocock/skills@0ab1b63, adapted (description sharpened vs. `grill-me`) |
