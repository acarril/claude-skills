...
**Grill the send, not the subject.** Interview the user only about the _send_, which they can always answer: who it goes to, and what they need back. The questions in the document then target the **gap** between what the recipient knows and what the user needs. Use the AskUserQuestion tool where the answers are pickable; prose where they need free text.

1. **Who is it going to?** Ask, in one exchange, the recipient's role, expertise, and relationship to the user. This fixes the questionnaire's tone, its language, and how much context it must carry. Done when you know who the recipient is and what they know that the user doesn't.
...
**Language.** Write the questionnaire in the recipient's working language: plain, neutral Latin American Spanish for MercadoLibre colleagues (keeping natural English business/tech terms), English otherwise. The conversation with the user stays in English regardless.
